...
export const Weapons: Array<EquipItem> = [
  ...
  { cost: 5, name: 'Axe, Battle', weight: 15, flags: InventoryItemFlag.VAR_HANDED | InventoryItemFlag.TWO_HANDED, damage: 'd8' },
  ...
  { cost: 1, name: 'Spear', weight: 10, flags: InventoryItemFlag.VAR_HANDED | InventoryItemFlag.MELEE_AND_MISSILE | InventoryItemFlag.TWO_HANDED, damage: 'd6' },
  { cost: 0, name: 'Staff', weight: 10, damage: 'd6' },
  { cost: 8, name: 'Sword, Short', weight: 5, damage: 'd6' },
  { cost: 20, name: 'Sword, Bastard', weight: 10, flags: InventoryItemFlag.VAR_HANDED | InventoryItemFlag.TWO_HANDED, damage: 'd8' },
