...
const AssassinEquipSet: EquipSet = {
  name: 'Assassin',
  items: [
    { name: 'Basic accessories', quantity: 1 },
    { name: 'Leather', quantity: 1 },
...
const FighterArcherEquipSet: EquipSet = {
  name: 'Fighter / Archer',
  items: [
    { name: 'Basic accessories', quantity: 1 },
    { name: 'Ring', quantity: 1 },
...
const FighterHeavyEquipSet: EquipSet = {
  name: 'Fighter / Heavy',
  items: [
    { name: 'Basic accessories', quantity: 1 },
...
const MagicUserEquipSet: EquipSet = {
  name: 'Magic User',
  items: [
    { name: 'Basic accessories', quantity: 1 },
    { name: 'Dagger', quantity: 1 },
